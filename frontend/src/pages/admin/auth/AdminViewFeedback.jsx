...
// const AdminViewFeedbackTable = () => {
//   const [feedbackList, setFeedbackList] = useState([]);
//   const [loading, setLoading] = useState(true);

//   // ✅ Fetch feedback data when component mounts
//   useEffect(() => {
//     axios.get("http://localhost:8080/api/feedback") // Your Spring Boot API
//       .then((res) => {
...
// export default AdminViewFeedbackTable;
...
//       const data = await fetchAllFeedback();  // Service API call
